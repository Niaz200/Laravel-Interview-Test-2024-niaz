                ...
                <div class="dashboard__inner__header__right">
                    <div class="dashboard__inner__item__right recent_activities">
                        ...
                        <div class="align-items-center col">
                            <button data-bs-toggle="modal" data-bs-target="#create-modal" class="cmn_btn btn_small radius-5">Create City</button>
                        </div>
...
<script>
    ...
    async function getList() {
        try {
            let res = await axios.get("/api/list-city", HeaderToken());
