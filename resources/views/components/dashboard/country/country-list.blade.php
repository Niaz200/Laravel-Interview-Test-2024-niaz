                ...
                <div class="dashboard__inner__header__right">
                    <div class="dashboard__inner__item__right recent_activities">
                        ...
                        <div class="align-items-center col">
                            <button data-bs-toggle="modal" data-bs-target="#create-modal" class="cmn_btn btn_small radius-5">Create Country</button>
                        </div>
        ...
        try {
            ...
            res.data['rows'].forEach(function(item, index) {
                let row = `<tr>
                       <td>${index + 1}</td>
                       <td>${item['name']}</td>
                       <td>${item['states'].map(state => state.name).join(', ')}</td>
